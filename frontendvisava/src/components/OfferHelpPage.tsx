...
// Reusing marker icon logic for simple drop pin
...
const SERVICES_LIST = [
  ...
  { id: 'toilets', label: 'Toilets', subtitle: 'Toilet facilities', icon: SquarePlay }, // using SquarePlay as placeholder for restroom
...
export const OfferHelpPage: React.FC = () => {
  ...
  const handleSubmit = async () => {
    ...
    // Prepare payload matching backend expectations (GeoJSON point)
    const payload = {
      name: 'Helper Service', // In real app, might take from user profile
      type: selectedServices[0], // Simplified mapping to backend enum
      location: {
        type: 'Point',
        coordinates: [location![1], location![0]] // [longitude, latitude]
      },
      description: description,
      contactPhone: contactPreference // Using this field temporarily
    };
          ...
          <>
            ...
            <section>
              ...
              <div className="map-preview-container">
                {/* Safe initial center if no location */}
                <MapContainer 
