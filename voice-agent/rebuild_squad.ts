...
async function rebuild() {
  ...
  const toolsToCreate = [
    { type: "function", function: { name: "find_nearby_food", description: "Use this to find nearby food facilities (Annachhatra, food distribution) for the user.", parameters: { type: "object", properties: { location_text: { type: "string" } }, required: ["location_text"] } }, server: { url: "https://entire-smartly-municipal.ngrok-free.dev/api/vapi/tools" } },
    { type: "function", function: { name: "find_nearby_accommodation", description: "Use this to find nearby accommodation (Bhakta Niwas, tents, shelter) for the user.", parameters: { type: "object", properties: { location_text: { type: "string" } }, required: ["location_text"] } }, server: { url: "https://entire-smartly-municipal.ngrok-free.dev/api/vapi/tools" } },
    { type: "function", function: { name: "find_nearby_medical", description: "Use this to find nearby medical facilities, hospitals, or clinics for the user.", parameters: { type: "object", properties: { location_text: { type: "string" } }, required: ["location_text"] } }, server: { url: "https://entire-smartly-municipal.ngrok-free.dev/api/vapi/tools" } },
    { type: "function", function: { name: "find_nearby_water", description: "Use this to find nearby drinking water facilities for the user.", parameters: { type: "object", properties: { location_text: { type: "string" } }, required: ["location_text"] } }, server: { url: "https://entire-smartly-municipal.ngrok-free.dev/api/vapi/tools" } }
  ];
